...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{../outputs/results/scaling_curve.png}
    \caption{Default-difficulty scaling: F1 vs.\ total sample size across ten model variants. Both \sys{} and CatBoost-with-context saturate near $97\%$ F1; the gap is within seed-level noise at 40{,}000 samples.}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{../outputs/results/scaling_curve_hard.png}
    \caption{Hard-difficulty scaling: F1 vs.\ total sample size. The ceiling drops to $\sim$$95\%$. Full \sys{} overtakes CatBoost-with-context at $n \approx 20{,}000$ and opens a statistically significant $0.21$ pp gap at $n = 40{,}000$.}
